...
public class BaseHibernateDAO {
    ...
    static {
        try {
            ...
            String pathParent = temp.getParent();

            String pathHibernateCfg = pathParent + File.separator + "etc" + File.separator + "hibernate.cfg.xml";
            configuration.configure(new File(pathHibernateCfg));
//            configuration.configure(pathHibernateCfg);
